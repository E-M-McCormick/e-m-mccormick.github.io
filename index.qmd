...
::: columns
::: {.column width="25%"}
![](./static/img/featured/var_smooths.png)
:::
::: {.column width="5%"}
<!-- empty column to create gap -->
:::
::: {.column width="70%"}
[**Modeling cycles, trends, and time-varying effects in dynamic structural equation models with regression splines.**]{style="font-size: 125%;"}

In hiearachical time series models, like dynamic structural equation models 
(DSEMs), standard model formulations typically assume a stationary process or 
simple (linear) trends that can be partialed out. However, in many phenomenon, 
we might expect more complex group and individual directional changes. 
To capture these nonlinear trends, in this paper we laid out a formulation of a
DSEM with semi-parametric splines to capture nonlinear changes in the outcome
over the assessment period. 

[Øystein Sørensen](https://www.sv.uio.no/psi/english/people/academic/oyss/),
**Ethan M. McCormick**    \
*Multivariate Behavioral Research*, 2025    \
[paper](static/pubs/44.Sorensen-McCormick-2025-MBR.pdf) \|
[preprint](https://doi.org/10.31234/osf.io/2ajpt) \| 
[supplemental material](https://osf.io/qpkmg/) \| 
DOI: [10.1080/00273171.2025.2507297](https://doi.org/10.1080/00273171.2025.2507297)
:::
:::
...
[Øystein Sørensen](https://www.sv.uio.no/psi/english/people/academic/oyss/) - University of Oslo
...
**Ethan M. McCormick**,
Mark de Rooij,   \
*preprint*, (accepted at *Multivariate Behavioral Research*)    \
<!-- [paper]() \|  -->
...
::: columns
::: {.column width="25%"}
![](static/img/students/wyatt-read.jpeg){fig-align="center" width=50%}
:::
::: {.column width="5%"}
<!-- empty column to create gap -->
:::
...
Wyatt Read is completing his PhD in Educational Statistics and Research Methods at the University of Delaware, supported by a Graduate Scholar Award. In his first year, he has contributed to projects surrounding the detection of differential item functioning (DIF) in scale scores.

[Wyatt Read](https://www.linkedin.com/in/wyatt-read-994510265),
**Ethan M. McCormick**, 
Sanford R. Student,   \
*in prep*    \
<!-- [paper]() \|  -->
