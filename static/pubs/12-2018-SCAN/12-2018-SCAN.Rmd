...
[<i class="fas fa-file-download"></i> PDF](12.McCormick-van-Hoorn-Cohen-Telzer-2018-SCAN.pdf) | [<i class="fas fa-quote-left"></i><i class="fas fa-quote-right"></i> BibTeX Citation](cite.bib) | [<i class="ai ai-open-data"></i> Dataset](https://neurovault.org/collections/2978/) | [<i class="fas fa-link"></i> DOI](https://doi.org/10.1093/scan/nsy064)
