...
[<i class="fas fa-file-download"></i> PDF](7.McCormick-Perino-Telzer-2018-DCN.pdf) | [<i class="fas fa-quote-left"></i><i class="fas fa-quote-right"></i> BibTeX Citation](cite.bib) | [<i class="ai ai-open-data"></i> Dataset](https://neurovault.org/collections/2039/) | [<i class="fas fa-link"></i> DOI](https://doi.org/10.1016/j.dcn.2018.01.012)
