...
[<i class="fas fa-file-download"></i> PDF](static/pubs/12-2018-SCAN/12.McCormick-van-Hoorn-Cohen-Telzer-2018-SCAN.pdf) | [<i class="fas fa-quote-left"></i><i class="fas fa-quote-right"></i> BibTeX Citation](static/pubs/12-2018-SCAN/cite.bib) | [<i class="ai ai-open-data"></i> Dataset](https://neurovault.org/collections/XPPOFEMU/) | [<i class="fas fa-link"></i> DOI](https://doi.org/10.1093/scan/nsy064)

```{r, echo=FALSE, fig.align='left', out.width='80%'}
knitr::include_graphics("../../../static/pubs/12-2018-SCAN/featured.png")
```
