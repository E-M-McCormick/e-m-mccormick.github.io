...
[<i class="fas fa-file-download"></i> PDF](30.Jorgensen-Muscatell-McCormick-Prinstein-Lindquist-Telzer-2023-SCAN.pdf) | [<i class="fas fa-quote-left"></i><i class="fas fa-quote-right"></i> BibTeX Citation](cite.bib) | [<i class="fas fa-link"></i> DOI](https://doi.org/10.1093/scan/nsac053)

[<i class="ai ai-open-data"></i> Dataset](https://neurovault.org/collections/LKQWGFEW/)
...
**Citation:** Jorgensen, N. A., Muscatell, K. A., McCormick, E. M., Prinstein, M. J., Lindquist, K. A., & Telzer, E. H. (2023). Neighborhood Disadvantage, Race/Ethnicity, and Neural Sensitivity to Social Threat and Reward among Adolescents. *Social Cognitive and Affective Neuroscience. 18*(1), 1-12.