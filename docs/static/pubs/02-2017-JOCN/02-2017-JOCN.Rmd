...
[<i class="fas fa-file-download"></i> PDF](static/pubs/02-2017-JOCN/2.McCormick-Telzer-2017-JOCN.pdf) | [<i class="fas fa-quote-left"></i><i class="fas fa-quote-right"></i> BibTeX Citation](static/pubs/02-2017-JOCN/cite.bib)  | [<i class="ai ai-open-data"></i> Dataset](https://neurovault.org/collections/1873/)| [<i class="fas fa-link"></i> DOI](https://doi.org/10.1162/jocn_a_01061)

```{r, echo=FALSE, fig.align='left', out.width='80%'}
knitr::include_graphics("../../../static/pubs/02-2017-JOCN/featured.png")
```
