...
[<i class="fas fa-file-download"></i> PDF](static/pubs/15-2019-NeruoImage/15.McCormick-Gates-Telzer-2019-NeuroImage.pdf) | [<i class="fas fa-quote-left"></i><i class="fas fa-quote-right"></i> BibTeX Citation](static/pubs/15-2019-NeruoImage/cite.bib) | [<i class="ai ai-open-data"></i> Dataset](https://neurovault.org/collections/3555/) | [<i class="fas fa-link"></i> DOI](https://doi.org/10.1016/j.neuroimage.2018.12.042)

```{r, echo=FALSE, fig.align='left', out.width='80%'}
knitr::include_graphics("../../../static/pubs/15-2019-NeruoImage/featured.png")
```
